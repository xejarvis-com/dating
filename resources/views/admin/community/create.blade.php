                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Add Title For Community</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ url('admin/community-add-process') }}" method="post">
                                    @csrf

                                    <div class="form-group">
                                        <label for="">Add Community Title</label>
