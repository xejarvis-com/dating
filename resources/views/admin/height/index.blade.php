                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <a href="{{ url('admin/height-add') }}" class="btn btn-primary">
                                                            ...
                                                            <table class="table table-striped table-bordered compact">
                                                                ...
                                                                @foreach($living as $item)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $item->height }}</td>
                                                                        <td>
                                                                            <a href="{{ url('/admin/height-edit') }}/{{ $item->id }}" class="btn btn-outline-info">Edit</a>
                                                                            <a href="{{ url('/admin/height-delete') }}/{{ $item->id }}" class="btn btn-outline-danger">Delete</a>
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                                </tbody>
