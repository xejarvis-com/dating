                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <div class="d-flex justify-content-between">
                                                        <h4 class="card-title">Register Sub Community </h4>
                                                        <a href="{{ url('admin/sub-community-add') }}" class="btn btn-primary">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped table-bordered compact">
                                                                ...
                                                                @foreach($living as $item)
                                                                    <tr>
                                                                        <td>{{ $item->id }}</td>
                                                                        <td>{{ $item->sub_community }}</td>
                                                                        <td>
                                                                            <a href="{{ url('/admin/sub-community-edit') }}/{{ $item->id }}" class="btn btn-outline-info">Edit</a>
