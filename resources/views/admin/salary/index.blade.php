                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <div class="d-flex justify-content-between">
                                                        <h4 class="card-title">Register Salary </h4>
                                                        <a href="{{ url('admin/salary-add') }}" class="btn btn-primary">
                                                            ...
                                                            <table class="table table-striped table-bordered compact">
                                                                ...
                                                                @foreach($living as $item)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $item->salary }}</td>
                                                                        <td>
                                                                            <a href="{{ url('/admin/salary-edit') }}/{{ $item->id }}" class="btn btn-outline-info">Edit</a>
                                                                            <a href="{{ url('/admin/salary-delete') }}/{{ $item->id }}" class="btn btn-outline-danger">Delete</a>
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                                </tbody>
