                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('/admin/status') }}">Material Status</a></li>
                            </ol>
                        </nav>
                        <div class="card">
                            <div class="card-body">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <div class="d-flex justify-content-between">
                                                        <h4 class="card-title">Register Material Status </h4>
                                                        <a href="{{ url('admin/status-add') }}" class="btn btn-primary">
