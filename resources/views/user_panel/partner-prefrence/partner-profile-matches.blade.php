...
<div class="container-fluid">
  <div class="row mt-5">
    <div class="col-md-9">
      <div class="card">
        <form action="{{ url('userPanel/partnerpreferences') }}" id="partner_preferences_form" method="post">
          @csrf
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-9 my-2">
                ...
                <div class="row slider-labels">
                  <div class="col-md-6 caption" style="color:#0F2E50; font-weight:bold;">
                    <strong>Min:</strong> <span id="slider-range-value1"></span>
                  </div>
                  <div class="col-md-6 text-right caption" style="text-align: right; color:#0F2E50; font-weight:bold;">
                    <strong>Max:</strong> <span id="slider-range-value2"></span>
                  </div>

                  <input id="min_height" type="hidden" name="min_height" value="0">
                  <input id="max_height" type="hidden" name="max_height" value="0">
                </div>
              </div>
            </div>
            <div class="row mt-4">
              ...
              <div class="col-md-9 my-2">
                ...
                <!--end::Slider-->
                <input id="min_age" type="hidden" name="min_age" value="0">
                <input id="max_age" type="hidden" name="max_age" value="0">
              </div>
            </div>
            <div class="row mt-4">
              <div class="col-3">
            ...
            <!-- <div class="row">
              ...
              <div class="col-9 d-flex">
                <label>
                  <input type="checkbox" name="relationship" id="" value="0" class="" />
                  Open to all
                </label>
                <label style="margin-left: 23px">
                  <input type="checkbox" name="relationship" id="" value="Self" class="" />
                  Self
                </label>
                <label style="margin-left: 23px">
                  <input type="checkbox" name="relationship" id="" value="Parent / Guardian" class="" />
                  Parent / Guardian
                </label>
                <label style="margin-left: 23px">
                  <input type="checkbox" name="relationship" id="" value="Sibling / Friend / Others" class="" />
            ...
            <div class="row mt-4">
              ...
              <div class="col-9 d-flex">
                ...
                <label style="margin-left: 23px">
                  <input type="checkbox" name="diet[]" id="" value="Non-Vegetarian">
                  Non-Veg
                </label>
                <label style="margin-left: 23px">
          ...
          <div class="card-footer">
            ...
            <button type="submit" class="btn btn-sm btn-success" class="float:right">Submit </button>
          </div>
...
<script>
  function getProfilePreferences(event, obj, form_id) {
    ...
    $.ajax({
      ...
      success: function(result) {
        ...
        if (result.status) {
          ...
          window.location = 'userPanel/partnerpreferences'
  ...
  $(document).ready(function() {
    ...
    slider.noUiSlider.on("update", function(values, handle) {
      if (handle) {
        ...
        $('#max_age').val(Math.round(values[handle]));
      } else {
        valueMin.innerHTML = Math.round(values[handle]);
        $('#min_age').val(Math.round(values[handle]));
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    rangeSlider.noUiSlider.on('update', function(values, handle) {
      ...
      $('#min_height').val(values[0]);
      $('#max_height').val(values[1]);
